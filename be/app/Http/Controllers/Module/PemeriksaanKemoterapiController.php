...
use App\Http\Requests\Module\PemeriksaanKemoterapiRequest;
...
class PemeriksaanKemoterapiController extends Controller
{
    protected $mainService;
    public function __construct()
    {
        $this->mainService = new PemeriksaanKemoterapiService();
    ...
    public function store(PemeriksaanKemoterapiRequest $request)
    {
    ...
    public function update($id, PemeriksaanKemoterapiRequest $request)
    {
