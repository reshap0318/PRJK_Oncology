...
use App\Http\Requests\Module\PemeriksaanToraksScanRequest;
...
class PemeriksaanToraksScanController extends Controller
{
    protected $mainService;
    public function __construct()
    {
        $this->mainService = new PemeriksaanToraksScanService();
    ...
    public function store(PemeriksaanToraksScanRequest $request)
    {
    ...
    public function update($id, PemeriksaanToraksScanRequest $request)
    {
